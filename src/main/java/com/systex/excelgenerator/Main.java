...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String[] headerColValues = {"School Name", "Major", "Grade", "Start Date", "End Date"};
        List<Object> educationData = new ArrayList<>();
        educationData.add("University of Washington");
        educationData.add("Informatics");
        educationData.add("4.0");
        educationData.add(LocalDate.of(1990, 1, 1));
        educationData.add(LocalDate.of(1991, 1, 1));

        dataMap.put(0, educationData);

        educationData = new ArrayList<>();
        educationData.add("University of Washington");
        educationData.add("Mathematics");
        educationData.add("3.75");
        educationData.add(LocalDate.of(1990, 1, 1));
        educationData.add(LocalDate.of(1991, 1, 1));

        dataMap.put(1, educationData);

        ExcelGenerationService excelGenerationService = new ExcelGenerationService();
        excelGenerationService.generateExcel(headerColValues, dataMap);
    }
}
